...
;(function(win, doc) {
    ...
    Upload = function() {
        ...
        mix(Upload.prototype, {
            ...
            ajax: function() {
                ...
                function param(data, traditional) {
                    ...
                    serialize(ary, data, traditional);
                ...
                return function(options) {
                    ...
                    var mime = settings.accepts[dataType],
                        ...
                        xhr = settings._xhr && settings._xhr() || this.xhr(),
                        abortTimeout;
            ...
            _getParamName: function(options) {
                ...
                if (!paramName) {
                    ...
                    if (!paramName.length) {
                        paramName = [fileInput.name || 'files[]'];
                    }
        ...
        mix(Upload, {
            xhr: Upload.prototype.xhr,

            ajax: Upload.prototype.ajax
        })
